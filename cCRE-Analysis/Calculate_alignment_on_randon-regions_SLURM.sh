...
#SBATCH --mem=50G
#SBATCH --time=30:00
#SBATCH -o ./log/calculate_alignment_on_randon-regions_SLUR.out
#SBATCH -e ./log/calculate_alignment_on_randon-regions_SLUR.err
#SBATCH --partition=30mins
#SBATCH --job-name=calculate_alignment_on_randon-regions_SLUR
...
bigWigAverageOverBed /tmp/kaili/${species}_aligned.bw hg38_random_10k_250bp.bed /tmp/kaili/${species}_alignment.tab
#
...
mv /tmp/kaili/${species}_alignment.t* ./alignment_random/
